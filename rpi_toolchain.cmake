set(RPI_ROOTFS /build/rootfs )
# set(CMAKE_FIND_ROOT_PATH ${RPI_ROOTFS} )
set(CMAKE_SYSROOT ${RPI_ROOTFS})

# compilers
set(tools "/build/tools/cross-pi-gcc-6.3.0-2/bin")
set(CMAKE_C_COMPILER   "${tools}/arm-linux-gnueabihf-gcc"    CACHE FILEPATH "")
set(CMAKE_CXX_COMPILER "${tools}/arm-linux-gnueabihf-g++"    CACHE FILEPATH "")
set(CMAKE_AR           "${tools}/arm-linux-gnueabihf-ar"     CACHE FILEPATH "")
set(CMAKE_RANLIB       "${tools}/arm-linux-gnueabihf-ranlib" CACHE FILEPATH "")
...
# C/CXX flags
set(CMAKE_CXX_FLAGS        "${CMAKE_CXX_FLAGS} -Wall ${RPI_INCLUDE_DIR}" CACHE STRING "" FORCE)
set(CMAKE_C_FLAGS          "${CMAKE_C_FLAGS} -Wall ${RPI_INCLUDE_DIR}" CACHE STRING "" FORCE)
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -B${RPI_ROOTFS}/usr/lib/arm-linux-gnueabihf" CACHE STRING "" FORCE)
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -B${RPI_ROOTFS}/lib/arm-linux-gnueabihf" CACHE STRING "" FORCE)
